      ...
      async function UpdateProfile() {
        ...
        try {
          const response = await Axios.patch(
            `https://ci-myhome.herokuapp.com/api/profiles/${GlobalState.userId}/update/`,
            formData
          );
        ...
        <>
          <Row className="text-center">
            ...
            >
              ...
              <img
                className="rounded my-3 placeholder-image"
                src="https://res.cloudinary.com/dsq1kzjdy/image/upload/v1663351361/media/image-placeholder_ooclbg.png"
              />

              <h5 className="text-center m-4">Information:</h5>
              <h6 className="text-center m-4">
                Please fill out required filed to update your profile
              </h6>
                  ...
                  <Col xs={9} sm={9} md={9} lg={9}>
                    ...
                    <ul className="mt-4">
                      {state.ProfilePictureValue ? (
                        <li>{state.profilePictureChosen.name}</li>
                      ) : (
                        ""
                      )}
                    </ul>
        ...
        <>
          <Row className="text-center">
            ...
            >
              ...
              <img
                className="rounded my-3 profile-image"
                src={
